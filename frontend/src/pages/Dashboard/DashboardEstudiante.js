...
const DashboardEstudiante = () => {
    ...
    const loadRegistrosYFormularios = useCallback(async () => {
        ...
        try {
            ...
            const registrosConEstado = registrosRes.data.map(registro => {
                ...
                const estadoNormalizado = (estadoStr === 'DENEGADO' || estadoStr === 'RECHAZADO') ? 'RECHAZADO'
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const formularioExistente = formularios.find(f => f.codigoUsuario === userCode &&
                f.estado === 'PENDIENTE');
